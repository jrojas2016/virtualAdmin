...
class rFrame(Tkinter.Frame):
	...
	def taskReminder(self):
		terminal_cmd = ['python', 'scripts/updateAsana.py', '--proj', 'debug', '--chan', 'debug']
	...
	def initUI(self):
		...
		self.parent.title("SHPE Virtual Admin")
...
def main():
	...
	img = ImageTk.PhotoImage(Image.open("media/shpe_logo.jpg"))
